...
\begin{frame}{Introduction}
	...
	\only<15>{\includegraphics[width=\textwidth]{slides/Introduction/15.pdf}}
\end{frame}
	...
	\begin{frame}
		...
		\begin{itemize}
			\item<1-> \textbf{Goal}: To develop acceleration techniques for efficient and high-quality inference and iterative optimization
