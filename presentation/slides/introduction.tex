...
\end{frame}
	...
	\begin{frame}
		...
		\begin{itemize}
			\item<1-> \textbf{Goal}:
To develop neural network acceleration techniques that ensure efficient and high-quality inference while supporting iterative optimization for low-power devices
