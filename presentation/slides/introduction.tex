...
\end{frame}
	...
	\begin{frame}
		...
		\begin{itemize}
			...
			\begin{itemize}
				\item<3-> Investigate optimizations for low-precision floating-point computation
				\item<4-> Conduct design exploration
				\item<5-> Evaluate deployment, performance and impact
